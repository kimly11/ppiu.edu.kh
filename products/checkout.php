...
<?php 
	...
	if(!isset($_SERVER['HTTP_REFERER'])){
		...
		header('location: http://localhost/ppiu.edu.kh');
		exit;
	}
...
?>
    <section class="home-slider owl-carousel">
      ...
      <div class="slider-item" style="background-image: url(<?php echo APPURL; ?>/images/chair.jpg);" data-stellar-background-ratio="0.5">
